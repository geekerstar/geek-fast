 ...
 */
@GeekEndpoint
public class GeekMetricsEndpoint {

    private final MeterRegistry registry;

    public GeekMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public GeekMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new GeekMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class GeekMetricResponse {
        ...
        GeekMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
